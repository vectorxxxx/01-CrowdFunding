                                ...
                                <c:forEach items="${requestScope.pageInfo.list}" var="admin" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="admin/to/edit/page/${admin.id}.html?pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}"
                                               class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                            <a href="admin/remove/${admin.id}.html?pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}"
