...
import com.vectorx.crowdfunding.properties.ShortMessageProperties;
import com.vectorx.crowdfunding.util.CrowdShortMessageUtil;
...
public class MemberHandler
{
    ...
    public String doRegister(MemberRegisterVO memberRegisterVO, ModelMap modelMap) {
        ...
        if (loginacct == null || "".equals(loginacct)) {
            modelMap.addAttribute(CrowdConstant.ATTR_NAME_MESSAGE, CrowdConstant.MSG_LOGIN_ACCT_NOT_NULL);
            return CrowdConstant.MEMBER_REG;
        }
        // 登录密码为空
    ...
    @ResponseBody
    @RequestMapping(CrowdConstant.SEND_SHORT_MESSAGE)
    public ResultEntity<String> sendMessage(@RequestParam("phoneNum") String phoneNum) {
        ...
        try {
            resultEntity = CrowdShortMessageUtil.sendMessage(url, signName, templateCode, accessKeyId, accessKeySecret, phoneNum, captcha);
        }
        catch (Exception e) {
