...
public class CrowdOSSUtilTest
{
    ...
    public void test() throws FileNotFoundException {
        ...
        final FileInputStream content = new FileInputStream("C:\\Users\\uxiah\\Pictures\\1.png");
        final ResultEntity<String> resultEntity = CrowdOSSUtil.uploadFile(endpoint, accessKeyId, accessKeySecret, securityToken, bucketName, bucketDomain, "1.png", content);
